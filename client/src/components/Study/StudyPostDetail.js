...
function StudyPostDetail() {
    ...
    useEffect(() => {
        const fetchPost = async () => {
            try {
                const response = await fetch(`/api/study/${studyRoomId}/posts/${postId}`, {
    ...
    const handleAddComment = async () => {
        const response = await fetch(`/api/study/${studyRoomId}/posts/${postId}/comments`, {
            method: 'POST',
            headers: {
    ...
    const handleDeleteComment = async (commentId) => {
        ...
        const response = await fetch(
            `/api/study/${studyRoomId}/posts/${postId}/comments/${commentId}`,
            {
                method: 'DELETE',
                headers: {
                    Authorization: `Bearer ${authToken}`,
